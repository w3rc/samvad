...
The full JSON Schema for the agent card is at [`schema/v1.2/agent-card.schema.json`](https://github.com/w3rc/samvad/blob/main/schema/v1.2/agent-card.schema.json).
