...
- **Not a discovery gate.** You can call any agent whose domain you know without any registry. A public registry is live at [samvadprotocol.vercel.app/registry](https://samvadprotocol.vercel.app/registry) for optional discovery, but participation is never required.
